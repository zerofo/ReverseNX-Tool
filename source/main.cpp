...
void RemoveReverseNX(u64 tid) {
	if (tid == UINT64_MAX) for (uint8_t i = 0; i < 3; i++) {
		snprintf(ReverseNX, sizeof ReverseNX, "sdmc:/switch/SaltySD/patches/%s", Files_64[i]);
		remove(ReverseNX);
		snprintf(ReverseNX, sizeof ReverseNX, "sdmc:/switch/SaltySD/patches/%s", Files_32[i]);
		remove(ReverseNX);
	}
	else for (uint8_t i = 0; i < 3; i++) {
		snprintf(ReverseNX, sizeof ReverseNX, "sdmc:/switch/SaltySD/patches/%016" PRIx64 "/%s", tid, Files_64[i]);
		remove(ReverseNX);
		snprintf(ReverseNX, sizeof ReverseNX, "sdmc:/switch/SaltySD/patches/%016" PRIx64 "/%s", tid, Files_32[i]);
		remove(ReverseNX);
	}
...
void setReverseNX(uint64_t tid, Flag changedFlag, bool bit32) {
	...
	for (uint8_t i = 0; i < 2; i++) {
		if (tid == UINT64_MAX) {
			if (!bit32) snprintf(ReverseNX, sizeof ReverseNX, "sdmc:/switch/SaltySD/patches/%s", Files_64[i]);
			else snprintf(ReverseNX, sizeof ReverseNX, "sdmc:/switch/SaltySD/patches/%s", Files_32[i]);
			...
			if (!bit32) snprintf(ReverseNX, sizeof ReverseNX, "sdmc:/switch/SaltySD/patches/%016" PRIx64 "/%s", tid, Files_64[i]);
			else snprintf(ReverseNX, sizeof ReverseNX, "sdmc:/switch/SaltySD/patches/%016" PRIx64 "/%s", tid, Files_32[i]);
			FILE* asem = fopen(ReverseNX, "wb");
			switch(changedFlag) {
				case Flag_Handheld:
					if (!bit32) fwrite(Handheld_64, 1, sizeof(Handheld_64), asem);
	...
	if (tid == UINT64_MAX) {
		if (!bit32) snprintf(ReverseNX, sizeof ReverseNX, "sdmc:/switch/SaltySD/patches/%s", Files_64[2]);
		else snprintf(ReverseNX, sizeof ReverseNX, "sdmc:/switch/SaltySD/patches/%s", Files_32[2]);
		FILE* asem = fopen(ReverseNX, "wb");
		switch(changedFlag) {
			case Flag_Handheld:
		...
		if (!bit32) snprintf(ReverseNX, sizeof ReverseNX, "sdmc:/switch/SaltySD/patches/%016" PRIx64 "/%s", tid, Files_64[2]);
		else snprintf(ReverseNX, sizeof ReverseNX, "sdmc:/switch/SaltySD/patches/%016" PRIx64 "/%s", tid, Files_32[2]);
		FILE* asem = fopen(ReverseNX, "wb");
		switch(changedFlag) {
			case Flag_Handheld:
				if (!bit32) fwrite(HandheldDefaultResolution_64, 1, sizeof(HandheldDefaultResolution_64), asem);
...
Flag getReverseNX(uint64_t tid) {
	...
	if (tid == UINT64_MAX) {
		snprintf(ReverseNX, sizeof ReverseNX, "sdmc:/switch/SaltySD/patches/%s", Files_64[0]);
		...
		if (asem != NULL) {
			...
			snprintf(ReverseNX, sizeof ReverseNX, "sdmc:/switch/SaltySD/patches/%s", Files_64[1]);
			...
			snprintf(ReverseNX, sizeof ReverseNX, "sdmc:/switch/SaltySD/patches/%016" PRIx64 "/%s", tid, Files_64[1]);
			asem = fopen(ReverseNX, "r");
			if (asem != NULL) {
				fclose(asem);
				RemoveReverseNX(tid);
		...
		snprintf(ReverseNX, sizeof ReverseNX, "sdmc:/switch/SaltySD/patches/%016" PRIx64 "/%s", tid, Files_64[0]);
		FILE* asem = fopen(ReverseNX, "r");
		if (asem != NULL) {
			fread(&filebuffer, 1, 16, asem);
			cmpresult = memcmp(filebuffer, Handheld_64, sizeof(Handheld_64));
